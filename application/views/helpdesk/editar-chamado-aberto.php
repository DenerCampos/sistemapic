...
<div id="mdlEditarChamadoAberto"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarChamadoAberto" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Mensagem de erro -->
            <div class="alert alert-danger text-center" id="erro-editar-chamado-aberto" hidden=""></div>
            
            <!-- Formulario de edição do chamado -->
            <form class="formulario" id="frmEdtChamadoAberto" method="post" enctype="multipart/form-data"
                  action="<?php echo base_url("ocorrencia/editarAberto") ?>">
                                ...
                                <div class="tab-pane fade active in" id="edita-ocorrencia">                        
                                    ...
                                    <div class="col-md-12 text-right">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="iptCriEnviarArea" id="iptCriEnviarEmail" value="emailarea" checked="true"> Enviar e-mail para área de atendimento (caso altere a área de atendimento).
                                        </label>
                                    </div>
