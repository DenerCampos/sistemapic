<!-- Modal de editar utilitario -->
<div id="mdlEditarUtilitario"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarUtilitario" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Edição programa</h4>
            </div>
            
            <!-- Mensagem de erro -->
           <div class="alert alert-danger text-center" id="erro-editar-utilitario" hidden=""></div>
            
            <!-- Formulario -->
            <form class="" id="frmEdtUtilitario" method="post" enctype="multipart/form-data" action="<?php echo base_url("utilitario/editar") ?>">
