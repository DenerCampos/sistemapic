<!-- Modal de editar pinpad -->
<div id="mdlEditarPinpad"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarPinpad" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Edição PinPad</h4>
            </div>
