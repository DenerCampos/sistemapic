<!-- Modal de criar pinpad -->
<div id="mdlCriarPinpad"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlCriarPinpad" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Novo PinPad</h4>
            </div>
