<!-- Modal de remover pinpad -->
<div id="mdlRemoverPinpad"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlRemoverPinpad" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Remover pinpad</h4>
            </div>
            ...
            <!-- Formulario -->
            <form class="" method="post" action="<?php echo base_url("pinpad/remove") ?>">
