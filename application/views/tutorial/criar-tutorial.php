<!-- Modal de criar tutorial -->
<div id="mdlCriarTutorial"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlCriarTutorial" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Novo tutorial</h4>
            </div>
            
            <!-- Mensagem de erro -->
            <div class="alert alert-danger text-center" id="erro-cria-tutorial" hidden=""></div>
            
            <!-- Formulario -->
            <form class="" id="frmCriTutorial" method="post" enctype="multipart/form-data" action="<?php echo base_url("tutorial/criar") ?>">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="iptCriNome" class="control-label">Nome tutorial:</label>
                        ...
                        <!-- anexo -->
                        <div class="col-md-12">
                            <label for="" class="control-label">Documento: <small>caso tenha</small></label>
                        </div>
                        <div class="col-md-12">
