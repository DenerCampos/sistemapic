<!-- Modal de remover Tutorial -->
<div id="mdlRemoverTutorial"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlRemoverTutorial" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Remover tutorial</h4>
            </div>
            ...
            <!-- Formulario -->
            <form class="frmRmvTutorial" method="post" action="<?php echo base_url("tutorial/remover") ?>">
