...
<div id="mdlEditarPos"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarPos" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Edição POS</h4>
            </div>
