<!-- Modal de criar pos -->
<div id="mdlCriarPos"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlCriarPos" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Novo POS</h4>
            </div>
