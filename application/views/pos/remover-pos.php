...
<div id="mdlRemoverPos"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlRemoverPos" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Remover pos</h4>
            </div>
            ...
            <!-- Formulario -->
            <form class="" method="post" action="<?php echo base_url("pos/remove") ?>">
