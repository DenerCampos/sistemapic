<!-- Modal de enviar e-mail avaliacao -->
<div id="mdlEmailAvaliacao"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEmailAvaliacao" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Enviar e-mail da avaliação</h4>
            </div>
            
            <!-- Mensagem de erro -->
            <div class="alert alert-danger text-center" id="erro-email-avaliacao" hidden=""></div>
            
            <!-- Formulario -->
            <form class="formulario" id="frmEmailAvaliacao" method="post" 
                  action="<?php echo base_url("avaliacao/enviarEmail") ?>">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="iptEmlNumero" class="control-label">Avaliação:</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="iptEmlData" class="control-label">Data avaliação:</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="iptEmlUsuario" class="control-label">Aluno:</label>
