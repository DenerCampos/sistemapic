<!-- Modal de editar impressora fiscal -->
<div id="mdlEditarFiscal"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarFiscal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Edição impressora fiscal</h4>
            </div>
            
            <!-- Mensagem de erro -->
           <div class="alert alert-danger text-center" id="erro-editar-fiscal" hidden=""></div>
            
            <!-- Formulario -->
            <form class="" id="frmEdtFiscal" method="post" action="<?php echo base_url("fiscal/atualizar") ?>">
                <div class="modal-body">
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="iptEdtNome" class="control-label">Caixa:</label>
