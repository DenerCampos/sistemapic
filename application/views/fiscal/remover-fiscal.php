<!-- Modal de remover impressora fiscal -->
<div id="mdlRemoverFiscal"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlRemoverFiscal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Remover impressora fiscal</h4>
            </div>
            ...
            <!-- Formulario -->
            <form class="" method="post" action="<?php echo base_url("fiscal/remove") ?>">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="iptRmvNome" class="control-label">Caixa:</label>
