<!-- Modal de criar impressora fiscal -->
<div id="mdlCriarFiscal"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlCriarFiscal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Nova impressora fiscal</h4>
            </div>
            ...
            <form class="" method="post" action="<?php echo base_url("fiscal/criar") ?>">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="iptCriNome" class="control-label">Caixa:</label>
