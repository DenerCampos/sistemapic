        ...
        <div class="row">
            ...
            <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">Pesquisa de relatórios por nome: <strong><?php echo $palavra; ?></strong></h3>
                    </div>
                ...
                <div class="alert alert-info alert-dismissible text-center alerta" role="alert">
                    ...
                    Não há <strong>relatórios de checklist</strong> com o termo <strong><?php echo $palavra ?></strong>.
                </div>
                <?php }?>
