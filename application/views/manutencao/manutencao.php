        ...
        <div class="col-md-12">
            <div role="tabpanel">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="comdefeito">
                    ...
                    <!-- em manutencao -->
                    <div role="tabpanel" class="tab-pane" id="emmanutencao">
                    ...
                    <!-- consertadas -->
                    <div role="tabpanel" class="tab-pane" id="consertadas">
                    ...
                    <!-- em garantia -->
                    <div role="tabpanel" class="tab-pane" id="emgarantia">
