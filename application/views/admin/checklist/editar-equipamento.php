...
<div id="mdlEditarEquipamento"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarEquipamento" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" 
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="formModalLabel">Editar equipamento checklist</h4>
            </div>
            <!-- Mensagem de erro -->
            <div class="alert alert-danger text-center" hidden=""></div>
            <form class="" method="post" 
                  action="<?php echo base_url("admin/equipamento_checklist_admin/atualizaEquipamento") ?>">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="selEdtGrupo" class="control-label">Grupo:</label>
                                <select name="selEdtGrupo" id="selEdtGrupo" 
