<!-- Modal de ativar -->
<div id="mdlAtivarEquipamento"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlAtivarEquipamento" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" 
                        aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="formModalLabel">Ativar equipamento checklist</h4>
            </div>
            <!-- Mensagem de erro -->
            <div class="alert alert-danger text-center"><strong>Tem certeza?</strong></div>
            <form class="" method="post" 
                  action="<?php echo base_url("admin/equipamento_checklist_admin/ativaEquipamento") ?>">
