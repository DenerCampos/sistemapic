...
<div id="mdlEditarSetor"  class="modal fade" tabindex="-1" role="dialog" 
     aria-labelledby="mdlEditarSetor" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="" method="post" 
                  action="<?php echo base_url("admin/setor_admin/atualizaSetor") ?>">
